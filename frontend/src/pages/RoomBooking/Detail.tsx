...
const Detail2 = () => {
  ...
  const { totalSelectedRooms, totalPrice, selectedRoomSummary } = useMemo(() => {
    const totalRooms = Object.values(selectedRooms).reduce((acc, count) => acc + count, 0);
    ...
    return { totalSelectedRooms: totalRooms, totalPrice, selectedRoomSummary };
  }, [selectedRooms, rooms]);
  ...
  const handlePrevious = () => {
    setSelectedImageIndex((prevIndex) => {
      ...
      const newIndex = (prevIndex - 1 + (hotel?.imageUrls.length || 0)) % (hotel?.imageUrls.length || 1); 
      return newIndex;
    });
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative rounded-lg overflow-hidden shadow-md w-2/3">
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            {hotel.imageUrls.length > 8 && (
              <div key="more-photos" className="h-[150px] flex-1 cursor-pointer" onClick={() => handleImageClick(8)}>
                <img
          ...
          >
            <div className="bg-white rounded-lg p-6 relative" onClick={(e) => e.stopPropagation()}>
              ...
              <button
                ...
                onClick={handleNext}
                disabled={selectedImageIndex === null || selectedImageIndex === hotel.imageUrls.length - 1} 
              >
                <FaArrowRight />
              </button>
